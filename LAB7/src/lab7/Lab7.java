...
public class Lab7 {
    ...
    private void runAnalysis() {
        ...
        helper.displayPostWithMostLikedComments();
        System.out.println("3.");
        helper.getMaximumCommentsPost();
        System.out.println("4.");
        helper.displayTop5InactiveUsers();
        System.out.println("5.");
        helper.getInactiveUsersBasedOnComments();
        System.out.println("6.");
        helper.getTopFiveInactiveUsers();
        System.out.println("7.");
        helper.getTopFiveProactiveUsers();
