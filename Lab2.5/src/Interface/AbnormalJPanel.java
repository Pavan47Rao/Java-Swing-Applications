...
public class AbnormalJPanel extends javax.swing.JPanel {
    ...
    private double maximumBP;
    private double minimumBP;
    public AbnormalJPanel(VitalSignHistory vsh, double maximumBP, double minimumBP) {
        initComponents();
        this.vsh = vsh;
    ...
    private void populateTable() {
        ...
        dtm.setRowCount(0);
        for (VitalSigns vs : vsh.getAbnormalList(maximumBP,minimumBP)) {
