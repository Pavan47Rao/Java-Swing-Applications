...
public class ProdManagementPanel extends javax.swing.JPanel {
    ...
    public ProdManagementPanel(ProductDirectory accDir, JPanel productContainer) {
        initComponents();
        this.accDir = accDir;
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        CreateProductJPanel panel = new CreateProductJPanel(accDir, productContainer);
        productContainer.add("CreateProductJPanel", panel);
    ...
    private void btnManageActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnManageActionPerformed
        // TODO add your handling code here:
        ManageProdPanel panel = new ManageProdPanel(accDir, productContainer);
        productContainer.add("CreateProductJPanel", panel);
        CardLayout layout = (CardLayout) productContainer.getLayout();
        layout.next(productContainer);
